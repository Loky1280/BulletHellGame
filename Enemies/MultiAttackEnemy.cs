...
namespace Enemies
{
    public class MultiAttackEnemy : Enemy
    {
        ...
        private static void EnsureFrames()
        {
            ...
            var sheet = new BitmapImage(new System.Uri("pack://application:,,,/Resource/Enemy/ShotGunEnemy.png"));
        ...
        public MultiAttackEnemy(Point position, Weapon weapon) : base(position, weapon)
        {
            Health = MaxHealth = 2;
            MoveSpeed = 80;
            Damage = 10;
