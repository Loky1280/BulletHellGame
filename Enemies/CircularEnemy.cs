...
namespace Enemies
{
    public class CircularEnemy : Enemy
    {
        ...
        private static void EnsureFrames()
        {
            ...
            var sheet = new BitmapImage(new System.Uri("pack://application:,,,/Resource/Enemy/CircleEnemy.png"));
        ...
        public CircularEnemy(Point position, Weapon weapon) : base(position, weapon)
        {
            Position = position;
