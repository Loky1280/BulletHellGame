...
Цей принцип можна побачити в класі [Weapon.cs](General%20logic/Weapon.cs), де оголошено віртуальний метод [CreateProjectile](General%20logic/Weapon.cs#L54), 
який перевизначається в дочірніх класах [AutomaticWeapon.cs](General%20logic/AutomaticWeapon.cs), [Pistol.cs](General%20logic/Pistol.cs), [ShotGun.cs](General%20logic/ShotGun.cs).
